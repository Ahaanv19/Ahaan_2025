...
| **Stacks / Queues** | **Met** | hunger_heroes_backend_spring- | [DonationService.java (Stack/LIFO undo via ArrayDeque)](https://github.com/Ahaanv19/hunger_heroes_backend_spring-/blob/dfde5110f6f4856da71f4118a8ebd343c72feda5/src/main/java/com/open/spring/mvc/donation/DonationService.java), [Queue.java (Queue data structure)](https://github.com/Ahaanv19/hunger_heroes_backend_spring-/blob/dfde5110f6f4856da71f4118a8ebd343c72feda5/src/main/java/com/open/spring/hacks/classDataStruct/Queue.java), [BathroomQueue.java](https://github.com/Ahaanv19/hunger_heroes_backend_spring-/blob/dfde5110f6f4856da71f4118a8ebd343c72feda5/src/main/java/com/open/spring/mvc/bathroom/BathroomQueue.java), [schema_full.txt](https://github.com/Ahaanv19/hunger_heroes_backend_spring-/blob/0acdd6a38f608f6ff6929ad849a78ecb1a8c148f/schema_full.txt) | The project documents queue and stack-related data structures as part of its internal rubric mapping and application design, including task queues and structured processing flows. |
| **Trees** | **Met** | hunger_heroes_backend_spring- | [DonationService.java (N-ary CategoryTree with DFS, TreeMap ordered structure)](https://github.com/Ahaanv19/hunger_heroes_backend_spring-/blob/dfde5110f6f4856da71f4118a8ebd343c72feda5/src/main/java/com/open/spring/mvc/donation/DonationService.java) | The requirements file documents tree structure evidence and references category tree testing. This shows tree-based structure usage in the backend. |
| **Sets** | **Met** | hunger_heroes_backend_spring- | [DonationConstants.java (unmodifiable HashSet for O(1) membership checks)](https://github.com/Ahaanv19/hunger_heroes_backend_spring-/blob/dfde5110f6f4856da71f4118a8ebd343c72feda5/src/main/java/com/open/spring/mvc/donation/DonationConstants.java), [WebSocketHandler.java (HashSet of sessions)](https://github.com/Ahaanv19/hunger_heroes_backend_spring-/blob/dfde5110f6f4856da71f4118a8ebd343c72feda5/src/main/java/com/open/spring/mvc/mortevision/nativesocket/WebSocketHandler.java) | Sets are used for uniqueness and filtering logic, including validation-style operations and allowed value control. |
...
| **Graphs** | **Met** | hunger_heroes_backend_spring- | [DonationGraph.java (adjacency list graph, BFS recommendations, connected components)](https://github.com/Ahaanv19/hunger_heroes_backend_spring-/blob/dfde5110f6f4856da71f4118a8ebd343c72feda5/src/main/java/com/open/spring/mvc/donation/DonationGraph.java) | The project documents graph data structure implementation and graph testing, including BFS/DFS-level evidence through its backend rubric mapping. |
| **2+ algorithms implemented with complexity analysis** | **Met** | hunger_heroes_backend_spring-, Ahaan_2025 | [DonationService.java (priority-score matching O(n·m), binary search O(log n))](https://github.com/Ahaanv19/hunger_heroes_backend_spring-/blob/dfde5110f6f4856da71f4118a8ebd343c72feda5/src/main/java/com/open/spring/mvc/donation/DonationService.java), [2025-6-08-homefinal.md](https://github.com/Ahaanv19/Ahaan_2025/blob/af1ed34f1da7d3d8ee3e9087bbdbab6a5d143e30/_posts/2025-6-08-homefinal.md) | My Spring backend explicitly documents algorithms including binary search, BFS, DFS, and priority scoring, while my blog portfolio also references Big-O and algorithm work completed in notebooks. |
| **Searching** | **Met** | hunger_heroes_backend_spring- | [DonationService.java (binary search by expiry date, O(log n))](https://github.com/Ahaanv19/hunger_heroes_backend_spring-/blob/dfde5110f6f4856da71f4118a8ebd343c72feda5/src/main/java/com/open/spring/mvc/donation/DonationService.java) | Search is documented both through search methods in repositories and through the project’s internal evidence of linear and binary search. |
...
| **Testing** | **Met** | hunger_heroes_backend_spring-, hunger_heroes_backend | [DonationServiceTest.java (JUnit/Mockito tests for donation service)](https://github.com/Ahaanv19/hunger_heroes_backend_spring-/blob/dfde5110f6f4856da71f4118a8ebd343c72feda5/src/test/java/com/open/spring/mvc/donation/DonationServiceTest.java), [POSTMAN_TESTING_GUIDE.md](https://github.com/Ahaanv19/hunger_heroes_backend/blob/52de39a86e669ba644ff33bbd5f37667f6816efa/docs/POSTMAN_TESTING_GUIDE.md) | My Java project documents JUnit/Mockito-style tests and broad testing coverage, while my Flask backend includes detailed Postman API testing workflows. |
| **JUnit tests for critical functionality (>50% coverage)** | **Met** | hunger_heroes_backend_spring- | [DonationServiceTest.java (73 tests across donation service, graph, entity, constants, and food item)](https://github.com/Ahaanv19/hunger_heroes_backend_spring-/blob/dfde5110f6f4856da71f4118a8ebd343c72feda5/src/test/java/com/open/spring/mvc/donation/DonationServiceTest.java) | The requirements file explicitly documents 73 tests across 6 files and identifies JUnit/service/data-structure coverage. |
